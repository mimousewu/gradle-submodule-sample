...
public class Unthrow {
    ...
    public static <R, E1 extends Exception, E2 extends Exception, E3 extends Exception,
        E4 extends Exception> Stream<R> of4(Stream<R> stream)
        throws E1, E2, E3, E4 {
        return stream;
    }
    ...
    public interface IProc1<T> {
        void accept(T trr) throws Exception;
    }
    ...
    public interface IFunc1<R, T> {
        R apply(T trr) throws Exception;
    }
    ...
    public static <T> void wrapProc(IProc1<T> proc, T trr) {
        try {
            proc.accept(trr);
        } catch (Exception ex) {
            rethrow(ex);
    ...
    public static <R, T> R wrap(IFunc1<R, T> func, T trr) {
        try {
            return func.apply(trr);
        } catch (Exception ex) {
            return rethrow(ex);
        }
    }
    ...
    public static <R, T1, T2, T3> R wrap(IFunc3<R, T1, T2, T3> func,
                                         T1 t1,
                                         T2 t2,
                                         T3 t3) {
        try {
